...
TARGET_NON_REACHABILITY = 'iwa-infer'
TARGET_NON_TERMINATION = 'iwa-infer-non-term'
...
def parse_stdout(stdout):
    ...
    stdout = stdout[idx:]
    result_data['result'] = 'fail' if idx == -1 else 'invalid' if 'Invalid' in stdout else 'valid' if 'Valid' in stdout else 'fail'
    return result_data
