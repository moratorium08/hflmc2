(set-logic HORN)
(set-info :source |
  Benchmark: /home/katsura/hflmc2/benchmark/ml/test_unsafe/repeat.ml
  Generated by MoCHi
|)
...
(assert (forall ((x0 Int)(x2 Int)(x1 Int)) (=> (and (|repeat[0:3][0:0]| x1 0 x2) (and (<= (+ 1 x2) x1) (>= x1 1))) (|fail_17[0:0]| x0))))
(assert (forall ((x1 Int)(x2 Int)(x0 Int)) (=> (and (|repeat[0:2]| x1 x2) (and (= x1 0) (= x0 x2))) (|repeat[0:3][0:0]| x1 x2 x0))))
(assert (forall ((x1 Int)(x0 Int)) (=> (and (= x0 0) (>= x1 1)) (|repeat[0:2]| x1 x0))))
(check-sat)
(get-model)
(exit)
