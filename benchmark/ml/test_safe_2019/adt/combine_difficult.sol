...
(model
  ...
  (define-fun |make_intlist_23[0:1][0:0]|
    ( (v_0 Int) (v_1 Int) ) Bool
    true
  )
  ...
  (define-fun |make_intlist_23[0:0]|
    ( (v_0 Int) ) Bool
    true
  )
  (define-fun |make_intlist[0:1]|
    ( (v_0 Int) (v_1 Int) ) Bool
    (|make_intlist_23[0:1][0:0]| 0 v_0)
  )
  (define-fun |combine[0:2]|
    ( (v_0 Int) (v_1 Int) ) Bool
    (exists ( (v_2 Int) ) (and (|length[0:2][0:0]| v_1 v_2) (|length[0:2][0:0]| v_0 v_2) (|make_intlist[0:2][0:0]| v_0 0 v_1) (|make_intlist_23[0:1][0:0]| 0 v_0)))
  )
)
