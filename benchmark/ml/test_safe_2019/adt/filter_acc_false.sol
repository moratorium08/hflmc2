...
(model
  ...
  (define-fun |filter_acc[0:0][0:1][0:0]|
    ...
    (exists ( (v_2 Int) (v_3 Int) ) (and (not v_1) (|make_int_list[0:1][0:0]| v_2 v_3)))
  )
  (define-fun |filter_acc[0:4][0:1][0:0]|
    ( (v_0 Int) (v_1 Int) (v_2 Int) (v_3 Int) ) Bool
    (exists ( (v_4 Int) ) (and (= v_0 0) (|make_int_list[0:1][0:0]| v_4 v_1) (|filter_acc[0:3]| 0 v_1) (|make_int_list[0:1][0:1][0:1][0:0]| v_4 v_1 v_2 0)))
  )
)
