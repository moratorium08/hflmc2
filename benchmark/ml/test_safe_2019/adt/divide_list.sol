...
(model
  ...
  (define-fun |divide[0:0]|
    ( (v_0 Int) ) Bool
    (exists ( (v_1 Int) ) (|make_intlist[0:1][0:0]| 0 v_0))
  )
  ...
  (define-fun |length[0:1][0:1][0:0]|
    ( (v_0 Int) (v_1 Int) (v_2 Int) ) Bool
    (exists ( (v_3 Int) ) (and (>= (* (- 1) v_0) 0) (|length[0:0]| v_0) (|make_intlist[0:1][0:1][0:1][0:0]| v_3 v_0 v_1 0) (|divide[0:0]| v_0) (|make_intlist[0:1][0:0]| 0 v_0)))
  )
)
